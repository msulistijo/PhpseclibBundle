...
class RSA
{
     ...
     * \Msulistijo\Phpseclib\Crypt\RSA doesn't do it is because OpenSSL doesn't fail gracefully.  openssl_pkey_new(), in particular, requires
     * openssl.cnf be present somewhere and, unfortunately, the only real way to find out is too late.
     *
     * @return \Msulistijo\Phpseclib\Crypt\RSA
     * @access public
     */
